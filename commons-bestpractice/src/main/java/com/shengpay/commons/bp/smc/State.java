...
package com.shengpay.commons.bp.smc;
...
public abstract class State implements Serializable {
     ...
     */
    public static final Integer TRANSITION_UNDEFINED = Integer.valueOf(0);

    /**
     * One (1) means the transition is defined in the current
     * state.
     */
    public static final Integer TRANSITION_DEFINED_LOCALLY = Integer.valueOf(1);
    /**
     * Two (2) means the transition is defined in the default
     * state.
     */
    public static final Integer TRANSITION_DEFINED_DEFAULT = Integer.valueOf(2);

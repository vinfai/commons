 ...
 *
 */
public class ClassName2InstanceUserType implements UserType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, Object owner) throws HibernateException, SQLException {
		...
		try {
			return ClassUtils.newInstance(Class.forName(className));
		} catch (ClassNotFoundException e) {
			throw new SystemException("无法找到类型【"+className+"】信息！");
		}
	}
